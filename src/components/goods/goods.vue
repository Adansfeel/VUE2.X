        ...
        <li v-for="item in goods" class="food-list food-list-hook">
          ...
          <ul>
            <li v-for="food in item.foods" class="food-item border-1px">
              <div class="icon">
                <img :src="food.icon" width="57px" height="57px" style="border-radius: 5px">
              </div>
              <div class="content">
                ...
                <div class="controlcart-wrapper">
                  <controlcart :food="food"></controlcart>  <!-- 传入food!!!-->
                </div>
              </div>
            </li>
          </ul>
...
<script type="text/ecmascript-6">
  ...
  import controlcart from 'components/controlcart/controlcart.vue';
  ...
  export default {
    ...
    methods: {
      selectMenu(index,event) {
        if (!event._constructed){ /*取消PC端默认双点击事件*/
          return;
        }
      ...
      _initScroll() {
        ...
        this.foodsScroll = new BScroll(this.$refs.foodsWrapper, {
          click:true,
          probeType: 3  /*BScroll滚动时实时监听滚动位置*/
        });
